...
st.write("대한민국 대표 엔터사들(JYP, YG, SM, HYBE)의 주가가 서로 유사하게 움직이는 지를 알아보기 위해 **피어슨 상관관계**를 구하고자 한다. HYBE의 주식 상장일(2020-10-15)을 기준으로 하여 최근까지의 주가를 크롤링 해서 대표 엔터사들 간의 상관계수를 구해보자.")
...
plot = sns.heatmap(stocks_df.corr(method = 'pearson'), cmap='YlOrRd', annot=True)
